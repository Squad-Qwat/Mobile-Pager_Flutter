...
class _PagerScanPageState extends State<PagerScanPage> 
{
  ...
  // Tidak disarankan menggunakan print() disini
  void _showScanResult(String data) 
  {
    if(kDebugMode){debugPrint('Scanned QR Code Data: $data');}
    else{stdout.write('Scanned QR Code Data: $data');}
  }
