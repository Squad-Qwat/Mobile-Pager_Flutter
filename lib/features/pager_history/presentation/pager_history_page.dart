...
class _HistoryPageState extends ConsumerState<HistoryPage> 
{
  ...
  void _applyFilters() => setState(() => _currentPage = 0);
  ...
  List<PagerModel> _applyLocalFilters(List<PagerModel> pagers) 
  {
    ...
    filtered.sort((a, b) 
    {
      ...
      if (_filterOptions.sortOrder == SortOrder.dateDescending) {return dateB.compareTo(dateA);} 
  ...
  List<PagerModel> _getPaginatedPagers(List<PagerModel> pagers) 
  {
    ...
    if (endIndex >= pagers.length) {return pagers;}

    return pagers.sublist(startIndex, endIndex);
  }

  bool _hasMore(List<PagerModel> pagers) => pagers.length > (_currentPage + 1) * _itemsPerPage;
            ...
            child: Container(
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<HistoryViewMode>(
                  ...
                  items: <DropdownMenuItem<HistoryViewMode>>[
            ...
            Expanded(
              ...
              : RefreshIndicator(
                ...
                child: ListView.builder(
                  ...
                  {
                    if (index == paginatedPagers.length) {return _buildLoadMoreButton();}
            ...
            Row(
              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: _getStatusColor(pager.status).withValues(alpha: 0.1),
                    borderRadius: BorderRadius.circular(6),
                    border: Border.all(
                      color: _getStatusColor(pager.status).withValues(alpha: 0.3),
                      width: 1,
                    ),
                  ),
                  child: Text(
  ...
  Widget _buildMerchantOrCustomerInfo(PagerModel pager) 
  {
    ...
    if (isMerchant) 
    {
      ...
      if (pager.customerId == null) {return SizedBox.shrink();}
